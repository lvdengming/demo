...
function handlePageLoad(event) {
  const isMobile = initDisplayView();
  if (isMobile) return;
...
function initDisplayView() {
  ...
  return clientStatus === ClientStatus.MOBILE;
}
